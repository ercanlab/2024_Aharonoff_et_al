...
phylogenetic_analysis contains scripts used to generate trees in Figures 1C, S2, S3, and S10 as well as Figures 1B and 1C.  RNA-seq contains scripts used for Figures 4, and S11-S14. Hi-C contains scripts for Figures 2, 3 and S4-S9. ChIP-seq contains scripts used for Figures 5, S15-S18.

**Detailed protocols for sample collection can be found in the sample_collection directory**

This page is a work in progress. If you need something that is not up yet, feel free to contact me at avramiaharonoff@gmail.com.
