...
input_id=AA96
genome=oscheius_tipulae.PRJNA644888.WBPS16.genomic # reference genome
input_fileName=input_AA96_CEW1_L-24hrs_ext790_oscheius_tipulae.PRJNA644888.WBPS16.genomic # bw file for input
 
## name format
# {target}_{antibody}_{strain}_{stage}_{ext#}_{subID}

declare -a query=(\
	"H4K20me1_ab8051_CEW1_L-24hrs_ext790_AA89" \
	"H3K4me3_ab8580_CEW1_L-24hrs_ext790_AA90" \
	"IgG_ab46540_CEW1_L-24hrs_ext790_AA91")
